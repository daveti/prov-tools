...
/* ImageMagick Protocol */
#define IMAGEMAGICK_FILE_NAME_LEN_MAX	512
struct provmsg_imagemagick_convert {
/*
	uint64_t src_inode;
	uint64_t dst_inode;
*/
	/* Use fixed size to ease msg parseing */
	int input_len;
	int output_len;
	char input[IMAGEMAGICK_FILE_NAME_LEN_MAX];
	char output[IMAGEMAGICK_FILE_NAME_LEN_MAX];
} __attribute__((packed));
